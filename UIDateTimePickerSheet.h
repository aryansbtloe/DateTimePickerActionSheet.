...
/*! Shows date/time or interval select action sheet
 ...
 \param initalDate - Action sheet starts with this date (for pickerMode = UIDatePickerModeTime, UIDatePickerModeDate or UIDatePickerModeDateAndTime otherwise ignored), can be nil, default: today's date
